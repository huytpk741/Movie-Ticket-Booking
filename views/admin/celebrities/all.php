<div class="content-wrapper">
    ...
    <?php } ?>
    <a style="margin-bottom: 30px; margin-left: 30px;" class="btn btn-success btn-md" href="<?= URL; ?>admin/celebrities/add/">Add</a>
    <div class="row">
          ...
          <div class="card-body">
            ...
            <table class="table table-bordered" id="table-celebrities">
              ...
              <tbody>
                ...
                <?php $count = 1; foreach ($celebrities as $celebrity) { ?>
                    <tr>
                        <td><?= $count; ?></td>
                        <td>
