    ...
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="navbar-brand-wrapper d-flex align-items-center">
          <a style="color:#ff7600;" class="navbar-brand brand-logo" href="<?= URL; ?>">
            Cinema
          </a>
        </div>
            ...
            <li class="nav-item dropdown d-none d-xl-inline-flex user-dropdown">
                <a class="nav-link dropdown-toggle" id="UserDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
                    ...
                    <?php if (empty($admin->picture)): ?>
                        <img class="img-xs rounded-circle ml-2" src="<?= ADMIN_IMG; ?>faces/default.png" alt="Profile image">
                    <?php else: ?>
              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                <div class="dropdown-header text-center">
                    ...
                    <?php if (empty($admin->picture)): ?>
                        <img  style="height:100px; width: 100px;" class="img-md rounded-circle" src="<?= ADMIN_IMG; ?>faces/default.png" alt="Profile image">
                    <?php else: ?>
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            <li class="nav-item nav-profile">
              <a href="#" class="nav-link">
                <div class="profile-image">
                    ...
                    <?php if (empty($admin->picture)): ?>
                        <img class="img-xs rounded-circle" src="<?= ADMIN_IMG; ?>faces/default.png" alt="Profile image">
                    <?php else: ?>
            ...
            <?php if ($this->is_super_admin()) { ?>
              <li class="nav-item"> <a class="nav-link" href="<?= URL; ?>admin/orders/all/"> Orders </a></li>
            <?php } ?>
            ...
            <?php if ($this->is_super_admin()) { ?>
              ...
              <li class="nav-item"> <a class="nav-link" href="<?= URL; ?>admin/subscribers/all/"> Subscribers </a></li>
              
              <li class="nav-item nav-category"><span class="nav-link">Movie managers</span></li>
