...
<head>
  ...
  <title>Ticket Booking Cancelled</title>
  <style type="text/css">
    /* ----- Client Fixes ----- */
                        ...
                        <table cellpadding="0" cellspacing="0" width="100%">
                          ...
                          <tr>
                            <td style="padding-bottom:20px;">
                              Hello {{ username }}, <br>
                              <br>
                              We would like you to know that your booking for the following ticket(s) has been cancelled! We are sorry for this inconvenience. You can contact us anytime to get help.<br>
                              <br>
                            </td>
                          </tr>
                        </table>
