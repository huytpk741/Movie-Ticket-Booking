            ...
            <table cellspacing="0">
              <tr>
                <td>
                  <table class="soapbox">
                    <tr>
                      <td class="soapbox-title">Reset Password!</td>
                    </tr>
                  </table>
                  ...
                  <table class="body">
                    <tr>
                      ...
                      <td class="body-padded">
                        <div class="body-title">Hey {{ name }}, we have received your request to reset your account's password.</div>
                        <table class="body-text">
                          <tr>
                            <td class="body-text-cell">
                              Kindly click the following button to reset your password.
                            </td>
                          </tr>
                        </table>
