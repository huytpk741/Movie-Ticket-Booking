            ...
            <table cellspacing="0">
              <tr>
                <td>
                  <table class="soapbox">
                    <tr>
                      <td class="soapbox-title">Welcome to Cinema</td>
                    </tr>
                  </table>
                        ...
                        <table class="status" bgcolor="#fffeea" cellspacing="0">
                          <tr>
                            <td class="status-cell">
                              Verification code: <b>{{ verification_code }}</b>
                            </td>
                          </tr>
                        </table>
                      </td>
                        ...
                        <table class="body-text">
                          <tr>
                            <td class="body-text-cell">
                              We're really excited for you to join our community! Kindly activate your account.
                            </td>
                          </tr>
                        </table>
