                    ...
                    <div class="col-lg-6 col-md-7">
                        <div class="hero-area-content pr-50">
                            ...
                            <div class="slide-trailor">
                                ...
                                <a class="theme-btn theme-btn2 btn-tickets-slider" href="<?= URL . 'movie/detail/' . $movie->movie->id; ?>"><i class="icofont icofont-play"></i> Tickets</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row hero-area-slide">
                        ...
                        <div class="col-lg-6">
                            <div class="hero-area-content pr-50">
                                ...
                                <div class="slide-trailor">
                                    <h3>Watch Trailer</h3>
                                    <a class="theme-btn theme-btn2" href="javascript:void(0);"><i class="icofont icofont-play"></i> Tickets</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="row portfolio-item spotlight">
                    ...
                    ?>
                        <div class="col-md-3 col-sm-6 all <?= $is_comming_soon ? 'soon' : 'latest'; ?>">
