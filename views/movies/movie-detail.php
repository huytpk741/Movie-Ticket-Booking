            ...
            <div class="row flexbox-center">
                <div class="col-lg-5 text-lg-left text-center">
                    <div class="movie-thumbnails transformers-content">
                        <?php $count = 0;
                        foreach ($movie->thumbnails as $thumbnail) : ?>
                        ...
                        <ul>
                                    ...
                                    <div class="row">
                                        ...
                                        foreach ($movie->cinemas as $cinema) : ?>
                                            <div class="col-md-3 transformers-bottom">
                                                <?php $date = new DateTime($cinema->movie_time);
                                                $now = new DateTime();
                            ...
                            <li>
                                ...
                                <div class="transformers-right">
                                    ...
                                    <a target="_blank" href="https://youtube.com/"><i class="icofont icofont-youtube-play"></i></a>
                                </div>
                            </li>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="details-content">
                    ...
                    <?php unset($_SESSION["post_comment_success"]);
                    endif; ?>
                    ...
                    <?php unset($_SESSION["post_comment_error"]);
                    endif; ?>
                        ...
                        <div class="buy-ticket-box">
                            ...
                            <?php if (isset($_SESSION["user"])) : ?>
                                <?php if ($is_currently_playing) : ?>
                                    <input style="background: #ff7600; color: white;" type="submit" class="theme-btn" value="Book Tickets" />
                                <?php else : ?>
                                    <input style="background: #ff7600; color: white;" type="button" class="theme-btn" value="Movie not being playing." disabled>
                                <?php endif; ?>
                            <?php else : ?>
                                <input style="background: #ff7600; color: white;" type="button" class="theme-btn" value="Please login to book a ticket." disabled>
                            <?php endif; ?>
                    ...
                    <div class="col-lg-3 offset-lg-1">
                        <div class="buy-ticket-box mtr-30">
                            ...
                            <ul>
                                ...
                                <li>
                                    <p>PAYMENT METHOD</p>
                                    <select class="form-control" id="selected_payment" name="selected_payment" required">
