...
<section class="transformers-area">
    <div class="container">
        <div class="transformers-box" style="background-color: white; color: black;">
            ...
            <?php foreach ($order_detail["tickets"] as $ticket) : ?>
                <div class="row">
                    <div class="col-md-12 seat">
                        <div style="margin-left:315px;" class="cardWrap ">
                            <div style="margin:0 auto;" class="card cardLeft">
                            ...
                            <div style="margin:0 auto;" class="card cardRight">
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <input type="text" name="coupon_code" class="form-control" required style="background: white; border: 1px solid #ced4da; height: 55px;" placeholder="Enter coupon code" />
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <input type="submit" name="submit" class="btn btn-info btn-lg" value="Apply" style="background-color: #ff7600;
                                        color: white;
                                        position: relative;
                                        top: 2px;
                    ...
                    <div class="cell example example4" id="example-4">
                        <form>
                            ...
                            <fieldset>
                                ...
                                <div class="container">
                                    <div style="margin: 10px 20px" id="stripe-card-element"></div>
                                    <button type="button" onclick="payViaStripe(this);" data-tid="elements_examples.form.donate_button">
                                        Pay now
                                    </button>
                                </div>
                            </fieldset>
            ...
            <div class="row" style="margin-top: 30px;">
                <div class="offset-md-3 col-md-6">
                    <h1 style="color: black; margin-bottom: 10px;" class="text-center">OR</h1>
...
<script>
        ...
        stripe
            ...
            .then(function(result) {
                ...
                if (result.error) {
                    ...
                    payment_successfull("Online Payment (Stripe)", result.paymentIntent.id);
    ...
    window.addEventListener("load", function() {
        stripe = Stripe('pk_test_51IYkWNAUBnKCtMsZQzpxXqQ3qkbHr19px19RFkg3SChkQlXZMausJY7EYAZlFeV0ZTxNZSnQlu2iljX12I6PO3Cl00cbSNmeN0');
        ...
        paypal.Button.render({
            ...
            client: {
                sandbox: 'Ac6uSMUiV_-xrC-U0gF5y5tNm-Pm1grv_-lJCJIf4Vul38MlmxMmYV-pPD2fDqF_g2DSYq8aatfUk4D1',
                production: 'EBffSWYXTHMXGa34PsUgHGrCReDL-k1TxjWLn3oVVZSCBZBqom072xJEj-iOkLvbD9hoZDfqfY0KJzJ_'
            },
            ...
            onAuthorize: function(data, actions) {
                return actions.payment.execute().then(function() {
                    ...
                    payment_successfull("Online Payment (Paypal)", paymentID);
                    var movie = "<?php echo $order_detail["movie"]->id; ?>";
